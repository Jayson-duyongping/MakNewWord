package com.jayson.commonlib.mvp.http.observer;

import com.google.gson.Gson;
import com.jayson.commonlib.mvp.http.function.ServerResultFunction;
...
public class HttpRxObservable {
     ...
     * @author ZhongDaFeng
     */
    public static Observable getObservable(Observable<ResponseBody> apiObservable) {
        // showLog(request);
     ...
     * @author ZhongDaFeng
     */
    public static Observable getObservable(Observable<ResponseBody> apiObservable, LifecycleProvider<ActivityEvent> lifecycle, ActivityEvent event) {
        // showLog(request);

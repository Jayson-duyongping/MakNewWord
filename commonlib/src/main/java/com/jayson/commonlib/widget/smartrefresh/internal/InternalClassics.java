package com.jayson.commonlib.widget.smartrefresh.internal;
...
//    protected SpinnerStyle mSpinnerStyle = SpinnerStyle.Translate;
    ...
    protected int mPaddingTop = 12;
    protected int mPaddingBottom = 12;
    ...
    public InternalClassics(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (thisView.getPaddingTop() == 0) {
            if (thisView.getPaddingBottom() == 0) {
                thisView.setPadding(thisView.getPaddingLeft(), mPaddingTop = density.dip2px(mPaddingTop), thisView.getPaddingRight(), mPaddingBottom = density.dip2px(mPaddingBottom));
            } else {
                thisView.setPadding(thisView.getPaddingLeft(), mPaddingTop = density.dip2px(mPaddingTop), thisView.getPaddingRight(), mPaddingBottom = thisView.getPaddingBottom());
            }
        } else {
            if (thisView.getPaddingBottom() == 0) {
                thisView.setPadding(thisView.getPaddingLeft(), mPaddingTop = thisView.getPaddingTop(), thisView.getPaddingRight(), mPaddingBottom = density.dip2px(mPaddingBottom));
            } else {

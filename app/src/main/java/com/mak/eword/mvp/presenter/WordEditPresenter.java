...
public class WordEditPresenter extends BasePresenter<IWordEditView, Activity> {

    private final String TAG = WordEditPresenter.class.getSimpleName();

    public WordEditPresenter(IWordEditView view, Activity activity) {
        super(view, activity);
    }
     ...
     * 单词新增
     */
    public void addWord(final Context context, final RequestBody body) {
        ...
        HttpRxObservable.getObservable(ApiUtils.getretrofitApi().addWord(body),
     ...
     * 单词修改
     */
    public void alterWord(final Context context, final RequestBody body) {
        HttpRxObserver httpRxObserver = new HttpRxObserver(TAG + "getInfo") {
        ...
        HttpRxObservable.getObservable(ApiUtils.getretrofitApi().alterWord(body),
                (LifecycleProvider<ActivityEvent>) context, ActivityEvent.PAUSE).subscribe(httpRxObserver);
    }
}
